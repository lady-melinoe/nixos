  ...
  systemd.services.melinoe-inet-setup =
    let
      ...
      setupScript = pkgs.writeShellScript "melinoe-inet-setup" ''
        ...
        ip netns exec inet ip addr replace 198.19.1.4/24 dev ens3
        ...
        ip netns exec inet iptables -t nat -C PREROUTING -d 198.19.1.4 -j DNAT --to-destination 198.18.0.4
        ip netns exec inet iptables -t nat -A PREROUTING -d 198.19.1.4 -j DNAT --to-destination 198.18.0.4 
