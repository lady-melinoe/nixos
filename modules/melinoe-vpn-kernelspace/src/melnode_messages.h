...
enum melnode_noise_limits {
	...
	MELNODE_KEEPALIVE_TIMEOUT = 10,
	MELNODE_REKEY_TIMEOUT = 5,
	MELNODE_MAX_TIMER_HANDSHAKES = 90 / 5,
	MELNODE_REKEY_JITTER_MAX_MS = 334,
	MELNODE_MAX_QUEUED_HANDSHAKES = 4096,
	MELNODE_UNDERLOAD_AFTER_TIME = 1,
	MELNODE_PADDING_MULTIPLE = 16,
